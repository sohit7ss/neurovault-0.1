    ...
    <div style={{
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="glass-card" style={{ padding: 32 }}>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input type="text" value={name} onChange={(e) => setName(e.target.value)}
                placeholder="John Doe" required className="glass-input" style={{ paddingLeft: 42 }} />
            </div>
          </div>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                placeholder="you@example.com" required className="glass-input" style={{ paddingLeft: 42 }} />
            </div>
          </div>
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input type={showPassword ? 'text' : 'password'} value={password}
                ...
                required className="glass-input" style={{ paddingLeft: 42, paddingRight: 42 }} />
          ...
          <p style={{
            fontSize: '0.78rem', color: 'var(--text-muted)', marginBottom: 24, lineHeight: 1.5,
          }}>
        ...
        <p style={{
          textAlign: 'center', marginTop: 24, fontSize: '0.9rem', color: 'var(--text-secondary)',
        }}>
